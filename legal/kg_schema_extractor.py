...
class KGSchemaExtractor:
    ...
    def __init__(self, options=None):
        ...
        """
        self.options = {
            "sparql_endpoint": "http://localhost:3030/lex2kg/query",
            "sample_size": 1000,
    ...
    def extract_schema(self):
        ...
        """
        print(f"Extracting schema from SPARQL endpoint: {self.options['sparql_endpoint']}")
    ...
    def categorize_property(self, property_info):
        ...
        if property_info.get("range"):
            # Numeric ranges
            if any(t in property_info["range"] for t in ["integer", "decimal", "float", "double"]):

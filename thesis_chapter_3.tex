...
]
{
  ...
  "sparql": "SELECT?value\n
  WHERE {\n  ns1:algorithm_design_and_analysis ns1:has_credits?value.\n}",
  "category": "university",
  "complexity": "basic",
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{assets/pics/salib2.jpg}
...
\begin{enumerate}
    ...
    \item \textbf{URI to Prefix Conversion}: Full URIs are replaced with prefixed notation for improved readability. For example, \texttt{<http://example.org/has\_credits>} becomes \texttt{ns1:has\_credits}, making queries more concise and easier for models to process.

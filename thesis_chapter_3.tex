...
\end{lstlisting}
    ...
    \item \textbf{Chain-of-Thought Integration}: The most significant improvement came from incorporating explicit reasoning steps before SPARQL generation. This approach guides the model through a structured thought process:
...
Based on these experiments, our final prompt configuration incorporates all discovered optimizations. The system prompt emphasizes structured reasoning and precise formatting requirements, while the assistant prompt template enforces the chain-of-thought pattern followed by properly formatted SPARQL. This configuration represents the culmination of our iterative optimization process and is used throughout all finetuning experiments reported in this thesis.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{assets/pics/evalframework.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{assets/pics/compareval.jpg}

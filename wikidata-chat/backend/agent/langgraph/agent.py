...
class WikidataGraphAgent:
    ...
    def build_graph(self):
        ...
        sparql_generation_node = SparqlGenerationNode(self.gemini_model, self.property_retrieval)
...
"""
    ...
    def query(self, question, verbose=0, boxology_verbose=0):
        ...
        if boxology_verbose > 0:
            visualizer = BoxologyVisualizer(boxology_verbose, debug_callback=self.debug_callback)

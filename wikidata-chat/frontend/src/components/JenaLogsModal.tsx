        ...
        <div className="space-y-6">
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-lg font-medium text-gray-900 mb-2">
              About Apache Jena Logs
            </h3>
            <p className="text-sm text-gray-500 mb-3">
              FrOG integrates with Apache Jena Fuseki to store visualization
              logs in RDF format. This enables powerful semantic querying of
              agent execution patterns, helping understand how the agent
              processes questions.
            </p>
            <div className="flex items-center justify-center mt-4">
              <a
                href="https://prepared-sheep-similarly.ngrok-free.app/#/dataset/visualization-logs/query"
                target="_blank"
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Use these queries on the Fuseki SPARQL endpoint to analyze agent
              execution patterns. Click the copy button to copy a query to your
              clipboard.
            </p>
              ...
              {exampleQueries.map((example, index) => (
                <div key={index} className="bg-white p-4 rounded-lg shadow-sm">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="font-medium text-frog-dark">
                      {example.title}
                    </h4>
                    <button

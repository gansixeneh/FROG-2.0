...
\begin{adjustbox}{width=\textwidth}
    ...
    \hline
    \RaggedRight{Qwen/Qwen2.5-7B-Instruct} & 7B & $0.2652$ & $\textbf{0.4838}$ & $+0.2186$ & 18T \cite{qwen2023} \\
    \RaggedRight{Qwen/Qwen2.5-Coder-7B-Instruct} & 7B & $0.3173$ & $0.4778$ & $+0.1605$ & 5.2T (70\% code) \cite{qwen2023} \\
    \RaggedRight{meta-llama/Llama-3.1-8B-Instruct} & 8B & $0.2556$ & $0.4694$ & $\textbf{+0.2138}$ & 15T \cite{llama3} \\
    \RaggedRight{mistralai/Mistral-Nemo-Instruct-2407} & 12B & $0.2587$ & $0.4565$ & $+0.1978$ & Undisclosed \cite{mistral2023} \\
    \hline
    \end{tabular}
\end{adjustbox}
\vspace{1em}

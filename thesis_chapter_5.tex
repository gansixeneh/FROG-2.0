...
We conduct several experiments to evaluate the performance of our enhanced GraphRAG system against the baseline system from the previous work. We assess the system holistically using Jaccard Similarity as our primary metric. Additionally, we evaluate the effectiveness of our fine-tuning approach by comparing base models against their fine-tuned counterparts. The information provided in this section is organized based on the knowledge graph domain.
